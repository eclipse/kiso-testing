...
class SuiteSetup(pykiso.GreyTestSuiteSetup):
    ...
    given by GreyTestSuiteSetup class and test_suite_setUp method.
...
class SuiteTearDown(pykiso.GreyTestSuiteTeardown):
    """This test suite setup will be executed using base behavior
    given by GreyTestSuiteTeardown class and test_suite_tearDown
    method.
...
class TestCaseBasic(pykiso.GreyTest):
    """This test case definition will be executed using base behavior
    given by GreyTest class and setUp, test_run, tearDown methods
