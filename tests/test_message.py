...
from pykiso.message import MessageType
from pykiso.message import MessageCommandType
from pykiso.message import TlvKnownTags
from pykiso.message import MessageAckType
...
class MessageTest(unittest.TestCase):
    ...
    def test_message_consistency_with_tlv_dict(self):
        ...
        self.assertEqual(
            message_mod.message_counter, message_for_test.get_message_token()
        )
    ...
    def test_message_serialization_no_tlv(self):
        ...
        expected_output = "400{:x}030000020300".format(message_mod.message_counter)
    ...
    def test_message_serialization_with_tlv(self):
        ...
        output_result = message_for_test.serialize()
        expected_output = (
            "400{:x}0300000203".format(message_mod.message_counter) + "09" + "6e" + "02" + "4f4b" + "70" + "03" + "123456"
        )
        self.assertEqual(expected_output, output_result.hex())
    ...
    def test_ack_message_matching(self):
        ...
        raw_ack_message_received = struct.pack('BBBBBBBB', 0x60, message_sent.msg_token, 0x00, 0x00, 0x01, 0x02, 0x03, 0x00)
        # Parse and compare
