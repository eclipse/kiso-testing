...
;-------------------------------------------------------------------------------
;   Connection                                Bit rate
;   PCAN_USBBUS1 (/dev/pcan32)           f_clock=80000000,nom_brp=2,nom_tseg1=63,nom_tseg2=16,nom_sjw=16,data_brp=4,data_tseg1=7,data_tseg2=2,data_sjw=2,
;                                        Nominal: 500 kBit/s (0x301), Data: 2 MBit/s (80 MHz)
;-------------------------------------------------------------------------------
; Glossary:
