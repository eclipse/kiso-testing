...
"""
Double Threaded Proxy Auxiliary
*******************************

:module: dt_proxy_auxiliary
...
class DTProxyAuxiliary(DTAuxiliaryInterface):
    ...
    def get_proxy_con(self, aux_list: List[Union[str]]) -> Tuple:
        ...
        for aux in aux_list:
            ...
            # alias list
                ...
                aux_inst = ConfigRegistry.get_auxes_by_alias(aux)
                self._check_compatibility(aux_inst)
                channel_inst.append(aux_inst.channel)
    ...
    def _dispatch_tx_method_to_channels(self) -> None:
        ...
        This method use the thread safe method implemented by each proxy
